...
WebUI.verifyElementPresent(findTestObject('Inventory/dropdown_sort'), 5)

WebUI.selectOptionByValue(findTestObject('Inventory/dropdown_sort'), 'Price (low to high)', false)
